...
public class GameClockTimeScript : MonoBehaviour
{
    ...
    RoundManagerScript thisGameRoundManagerScript;
    ...
    void Start()
    {
        ...
        thisGameRoundManagerScript = thisGameRoundManager.GetComponent<RoundManagerScript>();
