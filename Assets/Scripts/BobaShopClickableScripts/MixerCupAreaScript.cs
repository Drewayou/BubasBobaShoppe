...
public class MixerCupAreaScript : MonoBehaviour
{
    ...
    public void InteractWithMixerCupArea(){
        ...
        if(handInventory.transform.childCount == 0 && gameObject.transform.childCount != 0){
        ...
        }else if(handInventory.transform.childCount != 0 && handInventory.transform.GetChild(0).gameObject.name == "EmptyCup(Clone)" && gameObject.transform.childCount == 0){
