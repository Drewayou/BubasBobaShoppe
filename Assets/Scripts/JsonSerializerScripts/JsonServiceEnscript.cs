...
public class JsonDataService : Inter_Dataservice
{

    //FIXME: Be aware that your files will be UNENCRYPTED
    ...
    public bool SaveData<T>(string RelativePath, T Data, bool Encrypted)
    {
        ...
        try
        {
            ...
            if (Encrypted)
            {
                //FIXME:WriteEncryptedData(Data, stream);
            }
            else
            {
                stream.Close();
    ...
    */
    ...
    public T LoadData<T>(string RelativePath, bool Encrypted)
    {
        ...
        try
        {
            ...
            if (Encrypted)
            {
                //FIXME: data = ReadEncryptedData<T>(path); 
                //^^^^^^Change method for encrypted
